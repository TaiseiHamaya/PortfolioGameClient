...
static constexpr const ::_pb::EnumDescriptor *PROTOBUF_NONNULL *PROTOBUF_NULLABLE
    file_level_enum_descriptors_common_2fmath_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor *PROTOBUF_NONNULL *PROTOBUF_NULLABLE
    file_level_service_descriptors_common_2fmath_2eproto = nullptr;
const ::uint32_t
    TableStruct_common_2fmath_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::Proto::Vector3, _impl_._has_bits_),
...
const char descriptor_table_protodef_common_2fmath_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\021common/math.proto\022\005Proto\"*\n\007Vector3\022\t\n"
    "\001x\030\001 \001(\002\022\t\n\001y\030\002 \001(\002\022\t\n\001z\030\003 \001(\002b\006proto3"
};
static ::absl::once_flag descriptor_table_common_2fmath_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_common_2fmath_2eproto = {
    false,
    false,
    78,
    descriptor_table_protodef_common_2fmath_2eproto,
    "common/math.proto",
    &descriptor_table_common_2fmath_2eproto_once,
    nullptr,
    0,
    1,
    schemas,
    file_default_instances,
    TableStruct_common_2fmath_2eproto::offsets,
    file_level_enum_descriptors_common_2fmath_2eproto,
    file_level_service_descriptors_common_2fmath_2eproto,
};
namespace Proto {
// ===================================================================
...
Vector3::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::Proto::Vector3>(),  // to_prefetch
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_common_2fmath_2eproto),
         ::std::false_type{});
